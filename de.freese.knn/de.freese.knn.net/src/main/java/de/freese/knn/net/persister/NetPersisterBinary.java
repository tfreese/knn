...
public class NetPersisterBinary extends AbstractNetPersister
{
	...
	/**
	 * @see de.freese.knn.net.persister.INetPersister#load(java.io.InputStream, de.freese.knn.net.NeuralNet)
	 */
	@Override
	...
	/**
	 * @see de.freese.knn.net.persister.AbstractNetPersister#loadLayer(java.io.InputStream)
	 */
	@Override
	...
	/**
	 * @see de.freese.knn.net.persister.AbstractNetPersister#loadMatrix(java.io.InputStream)
	 */
	@Override
	...
	/**
	 * @see de.freese.knn.net.persister.AbstractNetPersister#save(java.io.OutputStream,
	...
	/**
	 * @see de.freese.knn.net.persister.AbstractNetPersister#saveLayer(java.io.OutputStream,
	...
	/**
	 * @see de.freese.knn.net.persister.AbstractNetPersister#saveMatrix(java.io.OutputStream,
