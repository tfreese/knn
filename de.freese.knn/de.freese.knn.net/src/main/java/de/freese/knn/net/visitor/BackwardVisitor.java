...
public class BackwardVisitor extends AbstractKnnVisitor
{
	 ...
	 */
	public BackwardVisitor(final TrainingContext trainingContext,
			final ForwardVisitor forwardVisitor)
	{
		super();
	 ...
	 * @return double[][]
	 */
	public double[][] getDeltaWeights(final ILayer layer)
	{
	 ...
	 * @return double[]
	 */
	public double[] getErrors(final ILayer layer)
	{
	 ...
	 * @return double[]
	 */
	public double[] getOutputs(final ILayer layer)
	{
	 ...
	 * @param errors double[]
	 */
	public void setErrors(final ILayer layer, final double[] errors)
	{
